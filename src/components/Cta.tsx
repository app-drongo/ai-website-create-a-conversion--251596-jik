...
export default function Cta() {
  const stats = [
    { value: "10K+", label: "Tests Automated", icon: Zap },
    { value: "99.9%", label: "Test Reliability", icon: Shield },
    { value: "85%", label: "Faster Deployment", icon: Sparkles },
    { value: "500+", label: "QA Teams", icon: Users }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join leading tech teams who've accelerated their testing cycles with TestPro. 
                Automate complex test scenarios and ship with confidence.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by innovative development teams worldwide
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                30 days free access to all testing features
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SOC 2 compliant with advanced security controls
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Connect with your CI/CD pipeline in under 5 minutes
              </p>
            </div>
          </div>
        </div>
